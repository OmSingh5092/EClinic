...
public class GetStartedActivity extends AppCompatActivity implements  GoogleApiClient.OnConnectionFailedListener{
                ...
                public void onResponse(Call<TokenResponseModel> call, Response<TokenResponseModel> response) {
                    if(response.isSuccessful() && response.code() == 200){
                        ...
                        if(tokenModel.isSuccess()) {
                            ...
                            prefs.setUserType(isPatient);
                            AuthCredential credential = GoogleAuthProvider.getCredential(account.getIdToken(), null);
                            firebaseAuthWithGoogle(credential);
                        }else{
                            Toast.makeText(GetStartedActivity.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(GetStartedActivity.this, "Login successful", Toast.LENGTH_SHORT).show();
                            if(prefs.getNewUser()){
                                goToOnboarding();
                            }else {
                                gotoHome();
    ...
    private void gotoHome() {
        Intent intent;
        if(isPatient){
            intent = new Intent(GetStartedActivity.this, PatientHomeActivity.class);
        }else{
            intent = new Intent(GetStartedActivity.this, DoctorHomeActivity.class);
        }
    ...
    private void goToOnboarding() {
        Intent intent;
        if(isPatient){
            intent = new Intent(GetStartedActivity.this, PatientRegisterActivity.class);
        }else{
            intent = new Intent(GetStartedActivity.this, DoctorRegisterActivity.class);
        }
